...
all_spp <- function(PC, x="PC1", y="PC2") {
  ...
  plot <- plot + geom_point(data=dat, aes(x, -y),size=2, colour="grey")
  ...
  plot <- plot + annotate("text", x = (PCAloadings$PC1*c(4.6,5.35,5,7.5,6.5,6)), y = -(PCAloadings$PC2*c(4.3,5,5,7,5.8,6.5)),
