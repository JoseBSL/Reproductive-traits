...
all_spp <- function(PC, x="PC1", y="PC2") {
  ...
  plot <- plot + annotate("text", x = (PCAloadings$PC1*c(4.6,4.95,5.5,6.25,6.3,6.15)), y = -(PCAloadings$PC2*c(4.693,2.4,3,6.2,5,5.5)+c(0,0,0,0,0.4,0)),
