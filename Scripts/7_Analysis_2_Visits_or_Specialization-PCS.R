...
degree <- brm(degree ~ PC1 + PC2 + PC3 + (1|System/Id),
                             data = data_analysis_2, family  = zero_inflated_negbinomial(), cores = 4,chains = 4, 
                             sample_prior = TRUE, warmup = 500, iter = 2000,
                             control = list(adapt_delta = 0.99)) 
...
cowplot::plot_grid(Visits_PC1,Visits_PC2,Visits_PC3,Specialization_PC1, Specialization_PC2, Specialization_PC3, 
                   normalised.degree_PC1, normalised.degree_PC2, normalised.degree_PC3, ncol=3)
