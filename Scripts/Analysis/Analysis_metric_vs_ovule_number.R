...
all_df$ovules_mean <- as.numeric(all_df$ovules_mean)
all_df$Visits <- as.numeric(all_df$Visits)
...
ggplot(mydf, aes(x = x, y = predicted)) + theme_ds4psy() + theme(legend.position = "none") +xlab("Ovule number")+ ylab("Predicted visits")+geom_point(data= all_tf, aes(x =ovules_mean , y = pred))+
  geom_line( alpha = 1)+ geom_ribbon(aes(x = x,ymin = conf.low, ymax = conf.high, fill = group), alpha = 0.1, colour = NA)


saveRDS(model_1, "Data/RData/model_1_visits_ovule_number.rds")
saveRDS(all_tf, "Data/RData/data_plot_visits_ovule_number.rds")
...
ggplot(mydf, aes(x = x, y = predicted)) + xlab("Ovule number")+ theme_ds4psy() + theme(legend.position = "none") + ylab("Predicted visits")+geom_point(data= all_tf, aes(x =ovules_mean , y = pred))+
  geom_line( alpha = 1)+ geom_ribbon(aes(x = x,ymin = conf.low, ymax = conf.high, fill = group), alpha = 0.1, colour = NA)


saveRDS(all_tf, "Data/RData/data_plot_visits_ovule_number_2.rds")
saveRDS(model_2, "Data/RData/model_2_visits_ovule_number_2.rds")
saveRDS(pred, "Data/RData/pred_plot_visits_ovule_number_2.rds")
...
ggplot(mydf, aes(x = x, y = predicted)) + theme_ds4psy() + theme(legend.position = "none") + xlab("Ovule number")+ ylab("Predicted degree")+ geom_point(data= all_tf, aes(x =ovules_mean , y = pred))+
  geom_line( alpha = 1, fill=c("blue", "red", "green"))+ geom_ribbon(aes(x = x,ymin = conf.low, ymax = conf.high, fill = group), alpha = 0.1, colour = NA)


saveRDS(all_tf, "Data/RData/data_plot_visits_ovule_number_3.rds")
saveRDS(model_3, "Data/RData/model_3_visits_ovule_number_3.rds")
saveRDS(pred, "Data/RData/pred_plot_visits_ovule_number_3.rds")
...
ggplot(mydf, aes(x = x, y = predicted)) + theme_ds4psy() + theme(legend.position = "none") + xlab("Ovule number")+ ylab("Predicted d")+geom_point(data= all_tf, aes(x =ovules_mean , y = pred))+
  geom_line( alpha = 1)+ geom_ribbon(aes(x = x,ymin = conf.low, ymax = conf.high, fill = group), alpha = 0.1, colour = NA)


saveRDS(all_tf, "Data/RData/data_plot_visits_ovule_number_5.rds")
saveRDS(model_5, "Data/RData/model_5_visits_ovule_number_5.rds")
saveRDS(pred, "Data/RData/pred_plot_visits_ovule_number_5.rds")
