...
ggplot(data=p1[[1]], aes(x = flower_symmetry, y = log(visits),color = ordered(flower_symmetry))) +
  ...
  geom_point(data=p1[[1]], mapping=aes(x=flower_symmetry, y=log(estimate__)), color="black") + ylab("log(Visits)") + xlab("Selfing level")+
...
ggplot(data=p2[[1]], aes(x = flower_symmetry, y = z_score_sum,color = ordered(flower_symmetry))) +
  ...
  geom_point(data=p2[[1]], mapping=aes(x=flower_symmetry, y=estimate__), color="black") + ylab("Z-score") + xlab("Selfing level")+
  theme(legend.position = "none")
