...
####
##
# NETWORK ANALYSIS VISITS~OVULE NUMBER
##
###
####
#####
...
m1 <- brm(visits ~ ovules_mean + (1|net_id) + (1|gr(phylo, cov = A)),
...
m2 <- brm(z_score_sum ~ ovules_mean + (1|net_id) + (1|gr(phylo, cov = A)),
...
#SAVE MODELS
setwd("~/R_Projects/Reproductive traits") 
save(m1, file = "Data/Brms/Ovule_number/brms_m1_visits_ovules_mean_negative_binomial.RData")
save(m2, file = "Data/Brms/Ovule_number/brms_m1_z-scores_ovules_mean_student.RData")
save(all_df_2, file = "Data/Brms/Ovule_number/brms_data_ovules_mean.RData")
