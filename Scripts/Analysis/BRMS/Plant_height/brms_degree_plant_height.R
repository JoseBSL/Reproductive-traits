...
m1 <- brm(degree ~ plant_height_mean_m + (1|net_id) + (1|gr(phylo, cov = A)),
...
#SAVE MODELS
setwd("~/R_Projects/Reproductive traits") 
save(m1, file = "Data/Brms/Plant_height/brms_m1_degree_plant_height_negative_binomial.RData")
save(all_df_2, file = "Data/Brms/Plant_height/brms_data_degree_plant_height.RData")
