...
m1 <- brm(degree ~ style_length_mm + (1|net_id) + (1|gr(phylo, cov = A)),
...
#SAVE MODELS
setwd("~/R_Projects/Reproductive traits") 
save(m1, file = "Data/Brms/Style_length/brms_m1_degree_style_length_negative_binomial.RData")
save(all_df_2, file = "Data/Brms/Style_length/brms_data_degree_style_length.RData")
