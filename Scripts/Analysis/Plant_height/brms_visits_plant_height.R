...
####
##
# NETWORK ANALYSIS VISITS~PLANT HEIGHT
##
###
####
#####
...
##########################################################
#4 Model1 (m1) VISITS~OVULE NUMBER
##########################################################
...
m1 <- brm(visits ~ plant_height_mean_m + (1|net_id) + (1|gr(phylo, cov = A)),
...
m2 <- brm(z_score_sum ~ plant_height_mean_m + (1|net_id) + (1|gr(phylo, cov = A)),
...
#SAVE MODELS
setwd("~/R_Projects/Reproductive traits") 
save(m1, file = "Data/Brms/Plant_height/brms_m1_visits_plant_height_negative_binomial.RData")
save(m2, file = "Data/Brms/Plant_height/brms_m1_z-scores_plant_height_student.RData")
save(all_df_2, file = "Data/Brms/Plant_height/brms_data_plant_height.RData")
