...
d_a <- readRDS("Data/RData/data_analysis_1_binomial.rds") #ALL SPP
########################################################################################################################################################
...
analysis_1_bee_apis <- brm(Interaction ~ PC1 + PC2 + PC3 +(1|System/Id) + (1|gr(phylo, cov = A)),
...
analysis_1_bee_apis 
summary(analysis_1_bee_apis)
bayes_R2(analysis_1_bee_apis)
loo_R2(analysis_1_bee_apis)


marginal_effects(analysis_1_bee_apis, effects = "PC1")
marginal_effects(analysis_1_bee_apis, effects = "PC2")
marginal_effects(analysis_1_bee_apis, effects = "PC3")


pp_check(analysis_1_bee_apis) +xlim(-50,200)+ylim(0,0.1)
pp_check(analysis_1_bee_apis, type='violin_grouped',group="Clusters")+ylim(-4,4)
pp_check(analysis_1_bee_apis, type='violin_grouped',group="guild")+ylim(-4,4)


ce_pc1 <- conditional_effects(analysis_1_bee_apis, effects = "PC1",points=T) 
...
ce_pc2 <- conditional_effects(analysis_1_bee_apis, effects = "PC2",points=T) 
...
ce_pc3 <- conditional_effects(analysis_1_bee_apis, effects = "PC3",points=T) 
...
saveRDS(analysis_1_bee_apis, "results_analysis_1_bee_apis_presence_absence.rds")
saveRDS(dat_analysis, "dat_analysis_results_analysis_1_bee_apis_presence_absence.rds")
