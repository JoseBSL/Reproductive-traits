...
saveRDS(analysis_1_bee_families_non_apis, "results_analysis_1_bee_families_non_apis_presence_absence.rds")
saveRDS(dat_analysis, "dat_analysis_results_analysis_1_bee_families_non_apis_presence_absence.rds")