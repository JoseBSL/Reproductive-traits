...
t <- grid::roundrectGrob(x=10, y=10, width=10, height=10)
...
t <- ggplot(ce_1[[1]], aes(x = Clusters, y = Interaction, colour = as.factor(guild), group = 
  ...
  scale_color_manual("Floral visitors guilds",values=c("#E69F00","#D55E00", "#287DAB", "#009E73", "#A7473A",  "black"))+  theme(panel.grid.major.x = element_blank(),panel.grid.minor.y  = element_blank())+   geom_vline(xintercept = c(1.5,2.5,3.5,4.5), linetype="dashed", color = "black", size=0.5)
  
t_1 <-  t + annotation_custom(l, xmin = 1.17, xmax =1.28 , ymin = -5.5, ymax =-0.5)+
  annotation_custom(l, xmin = 1.17, xmax =1.28 , ymin = -5.75, ymax =-0.5) +  
  annotation_custom(b, xmin = 0.55, xmax =0.70 , ymin = -5, ymax =0) + 
 annotation_custom(f, xmin = 0.67, xmax =0.87 , ymin = -4.5, ymax =-0.65) + 
 annotation_custom(s, xmin = 0.85, xmax =0.99 , ymin = -5.5, ymax =-0.25)+
  annotation_custom(d_1, xmin = 1.0, xmax =1.14 , ymin = -5, ymax =0) 

gg_table <- ggplot_gtable(ggplot_build(t_1))
