...
inFile1 <- "Data/Koeppen-Geiger-ASCII.txt"
...
###########################################################################################
##
## R source code to read and visualize Köppen-Geiger fields (Version of 23 September 2019)                                                                                    
##
...
# Read raster files
period='1986-2010'
r <- raster(paste('Data/KG_', period, '.grd', sep=''))
...
out=paste('KG_', period,'_30m.pdf', sep='')
...
write.csv(pts, file=paste('KG_', period,'_30m.csv', sep=''), row.names=F)
