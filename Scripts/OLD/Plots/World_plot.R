...
clim.zones$zone2 <- c('Tropical', 'Tropical', 'Tropical', 'Tropical', 'Arid', 'Arid', 'Arid', 'Arid', 
                      'Temperate', 'Temperate','Temperate', 'Temperate', 'Temperate', 'Temperate', 'Temperate','Temperate', 
                      'Temperate', 'Continental', 'Continental', 'Continental','Continental', 'Continental', 'Continental', 'Continental',
                      'Continental','Continental', 'Continental', 'Continental', 'Continental', 'Polar','Polar', NA)
...
longitude <- c(3.296797, 10.216667, 10.233333, 
               ...
               -52, 57.43, -90.600747, 171.566667,171.78466,171.720224)
...
latitude <- c(42.315336, 56.066667, 56.066667, 
              ...
              71, -20.25, -0.290164, -42.95,-43.02823, -43.099531)

locality <- c("Spain", "Denmark", "Denmark", 
              "Argentina", "England", "Denmark", 
              "Sweden", "Greenland", "China", 
              "Japan", "Australia", "Mauritius",
              "Japan", "Canada", "Greenland", 
              "Mauritius", "Galapagos", "New Zealand","New Zealand","New Zealand")
...
id <- c("bartomeus_2008_bat1ca.csv", "beck_2006.csv", "bundgaard_2003.csv", 
        ...
        "mcmullen_1993.csv", "primack_1983_arthurs_pass.csv", "primack_1983_cass.csv", "primack_1983_craigieburn.csv")
