...
p +  geom_scatterpie(aes(x=longitude, y=latitude,group=Id), 
  ...
  scale_fill_manual(breaks = colnames(data_merged_sub_ord[,c(7:9)]),
                    labels = c("Partially self compatible", "Self compatible", "Self incompatible"),values = c("patially_self_compatible" = "#4DAF4A",
                                                                                  "self_compatible" = "#984EA3","self_incompatible" = "orange")) +labs(title = "Compatibility systems",subtitle = "",
