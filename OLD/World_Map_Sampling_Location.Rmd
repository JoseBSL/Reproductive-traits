...
Long_format_metawebs <- readRDS("Long_format_metawebs.RData")
...
ggplot(data = world) + 
  geom_sf(color = "#E0E0E0", fill = "#EEEEEE", size=0.1,lwd = 0)+
  theme(axis.line = element_line(color='aliceblue'),
        plot.background = element_blank(),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank())+
  geom_point(data=metadata_sub, aes(longitude,latitude), shape = 16, colour = "#74c365",size = 2.35, alpha=0.9)+
