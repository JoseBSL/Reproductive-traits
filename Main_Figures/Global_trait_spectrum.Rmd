...
all_spp <- function(PC, x="PC1", y="PC2") {
  ...
  plot <- plot + theme_bw() + annotation_raster(tree_1, xmin = -4, xmax = -2.85,ymin = 2.05, ymax = 3.95)+
     annotation_raster(style_l_1, xmin = 2.05, xmax = 2.85,ymin = 2.35, ymax = 3.5) +
    annotation_raster(style_s_1, xmin = -2.7, xmax = -2,ymin = -2.65, ymax = -1.7) +
    ...
    annotation_raster(many_flowers_1, xmin = -4.60, xmax = -3.15,ymin = 0.9, ymax = 2.05) +
 ...
 plot <- plot + annotate("text", x = -(PCAloadings$PC1*c(4.6,5.5,5.5,7.25,7.3,6.15)), y = -(PCAloadings$PC2*c(4.77,2.4,3,6.2,5,5.5)+c(0,0,0,0,0.4,0)),
