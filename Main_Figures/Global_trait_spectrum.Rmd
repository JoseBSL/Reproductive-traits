...
all_spp <- function(PC, x="PC1", y="PC2") {
  ...
  plot <- plot + theme_bw() + annotation_raster(tree_1, xmin = -4, xmax = -2.9,ymin = 2.45, ymax = 4.35)+
    ...
    annotation_raster(style_s_1, xmin = -3.05, xmax = -2.25,ymin = -2.65, ymax = -1.75) +
    ...
    annotation_raster(single_flower_1, xmin = 2.8, xmax = 3.5,ymin = -2.8, ymax = -2.2) 
 ...
 plot <- plot + annotate("text", x = -(PCAloadings$PC1*c(4.6,5.5,5.5,7.5,7.3,6)), y = -(PCAloadings$PC2*c(4.77,2.4,3,6.5,5,5.5)),
