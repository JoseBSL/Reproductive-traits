...
all_spp <- function(PC, x="PC1", y="PC2") {
  ...
  plot <- plot + theme_bw() + annotation_raster(tree_1, xmin = -4, xmax = -2.85,ymin = 2.05, ymax = 3.95)+
    ...
    annotation_raster(selfing_h_1, xmin = -0.30, xmax = 0.15,ymin = -4.1, ymax = -3.25) +
    annotation_raster(single_flower_1, xmin = 3.3, xmax = 4.1,ymin = -1.7, ymax = -0.7) +
    annotation_raster(many_flowers_1, xmin = -4.20, xmax = -3.35,ymin = 0.8, ymax = 1.45) +
    annotation_raster(large_flower_1, xmin = 3.25, xmax = 4.25,ymin = 1.2, ymax = 2.45) +
    annotation_raster(flower_small_1, xmin = -3.60, xmax = -2.55,ymin = -2.2, ymax = -1.60) +
    annotation_raster(herb_1, xmin = 2.6, xmax = 3.1,ymin = -2.8, ymax = -2) 
