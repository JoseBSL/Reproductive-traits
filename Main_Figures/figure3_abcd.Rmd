...
```{r, echo=FALSE, message=FALSE, cache=FALSE, results='hide', warning=FALSE, fig.height=17, fig.width=27}
...
aes(x = -PC1, y = Interaction),size = 2.8, alpha=0.4) + geom_line(size=1.8)  + ylab("Interaction")+ xlab("")+
  theme_ms() + theme(legend.position = "none") + scale_color_manual(name="Functional groups",values=c("orange", "black", "limegreen","#E7298A", "cyan4","blueviolet"),labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera",
    "Non-syrphid-Diptera", "Syrphids"))+scale_y_continuous(breaks = c(0,  1), labels=c("No", "Yes"))
...
aes(x = -PC2, y = Interaction),size = 2.8, alpha=0.4) + geom_line(size=1.8)  + ylab("Interaction")+ xlab("")+
  theme_ms() + theme(legend.position = "none") + scale_color_manual(name="Functional groups",values=c("orange", "black", "limegreen","#E7298A", "cyan4","blueviolet"),labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera",
    "Non-syrphid-Diptera", "Syrphids"))+ scale_y_continuous(breaks = c(0,  1), labels=c("No", "Yes"))
...
pp1+pp2+p1 +p2 + theme(legend.position = "none")+ plot_layout(ncol = 2)
