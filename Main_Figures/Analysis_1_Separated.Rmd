...
pp1 <- ggplot(ce_pc1[[1]], aes(x = -PC1, y = (estimate__+1), group=guild, colour=guild)) + geom_point(data = dat_analysis,
  ...
  theme_ms() + theme(legend.position = "none",plot.title = element_text(size=rel(2),hjust = 0,face="bold")) + scale_color_manual(name="Functional groups",labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera",
