...
pp1 <- ggplot(ce_pc1[[1]], aes(x = -PC1, y = (estimate__+1), group=guild, colour=guild)) + geom_point(data = dat_analysis,
  ...
  theme_ms() + theme(legend.position = "none",plot.title = element_text(size=rel(2),hjust = 0,face="bold")) + scale_color_manual(name="Functional groups",labels=c("Anthophila-Hymenoptera (bees)","Coleoptera", "Lepidoptera", "Non-Anthophila-Hymenoptera",
   "Non-Syrphidae-Diptera", "Syrphidae-Diptera"),values=c("orange", "black", "limegreen","#E7298A", "cyan4","blueviolet"),
...
saveRDS(p1,"Main_Figures/figure_2_1.rds")
saveRDS(p2,"Main_Figures/figure_2_2.rds")
saveRDS(p3,"Main_Figures/figure_2_3.rds")
saveRDS(pp1,"Main_Figures/figure_2_4.rds")
saveRDS(pp2,"Main_Figures/figure_2_5.rds")
saveRDS(pp3,"Main_Figures/figure_2_6.rds")
