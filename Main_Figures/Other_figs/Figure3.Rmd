...
theme_ms <- function(base_size=14, base_family="Helvetica") {
  (theme_bw(base_size = base_size, base_family = base_family)+
     theme(text=element_text(color="black"),
           ...
           legend.key.size = unit(4.2, 'lines'),
...
#Plot nicely PC1
analysis_1 <- readRDS("../Data/Large_files/results_analysis_1_presence_absence.rds")
dat_analysis <- readRDS("../Data/Large_files/dat_analysis_results_analysis_presence_absence.rds")

ce_pc1 <- conditional_effects(analysis_1, effects = "PC1:guild",points=T) 

pp1 <- ggplot(ce_pc1[[1]], aes(x = -PC1, y = (estimate__), group=guild)) + 
geom_point(data = dat_analysis,
aes(x = -PC1, y = Interaction, colour=guild),size = 2.5, alpha=0.15) + 
geom_line(aes(colour=guild, linetype=guild, size=guild))  + 
ylab("Interaction") + 
xlab(NULL) +
theme_ms() + 
theme(legend.position = "none") + 
scale_color_manual(name="Functional groups",values=c("orange", "limegreen", "black","#E7298A","cyan4","blueviolet"),  labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera","Non-syrphid-Diptera", "Syrphids")) + 
ggtitle("PC1", subtitle = "(a)") + 
scale_y_continuous(breaks = c(0,  1), labels=c("No", "Yes")) +
scale_linetype_manual(values=c("solid","twodash", "dotted", "longdash", "dashed", "dotdash"), labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera", "Non-syrphid-Diptera", "Syrphids"), name="Functional groups")+
scale_size_manual(values=c(1.75, 1.75, 1.5, 1.75, 1.75, 1.75), labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera", "Non-syrphid-Diptera", "Syrphids"), name="Functional groups")

ce_pc2 <- conditional_effects(analysis_1, effects = "PC2:guild",points=T) 

pp2 <- ggplot(ce_pc2[[1]], aes(x = -PC2, y = (estimate__), group=guild)) + geom_point(data = dat_analysis, aes(x = -PC2, y = Interaction, colour=guild),size = 2.5, alpha=0.15) + 
geom_line(aes(colour=guild, linetype=guild,  size=guild))  + 
ylab(NULL)+ 
xlab(NULL)+
theme_ms() + 
theme(legend.position = "none") + 
scale_color_manual(name="Functional groups",values=c("orange", "limegreen", "black","#E7298A",        "cyan4","blueviolet"),labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera",
    "Non-syrphid-Diptera", "Syrphids")) + 
ggtitle("PC2", subtitle = "(b)") + 
scale_y_continuous(breaks = c(0,  1), labels=c("No", "Yes")) +
scale_linetype_manual(values=c("solid","twodash", "dotted", "longdash", "dashed", "dotdash"), labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera", "Non-syrphid-Diptera", "Syrphids"), name="Functional groups")+
scale_size_manual(values=c(1.75, 1.75, 1.5, 1.75, 1.75, 1.75), labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera", "Non-syrphid-Diptera", "Syrphids"),name="Functional groups")
...
pp3 <- ggplot(ce_pc3[[1]], aes(x = -PC3, y = (estimate__), group=guild)) + geom_point(data = dat_analysis, aes(x = -PC3, y = Interaction, colour=guild),size = 2.5, alpha=0.15) + 
geom_line(aes(colour=guild, linetype=guild, size=guild))  + ylab(NULL)+ xlab(NULL)+
theme_ms() +
theme(legend.position = "none") + 
scale_color_manual(name="Functional groups",values=c("orange", "limegreen", "black","#E7298A",            "cyan4","blueviolet"),labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera",
        "Non-syrphid-Diptera", "Syrphids")) + 
ggtitle("PC3", subtitle = "(c)") + 
scale_y_continuous(breaks = c(0,  1), labels=c("No", "Yes")) +
scale_linetype_manual(values=c("solid","twodash", "dotted", "longdash", "dashed", "dotdash"), labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera", "Non-syrphid-Diptera", "Syrphids"), name="Functional groups")+
scale_size_manual(values=c(1.75, 1.75, 1.5, 1.75, 1.75, 1.75), labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera", "Non-syrphid-Diptera", "Syrphids"), name="Functional groups")
...
#Plot nicely PC1
analysis_1 <- readRDS("../Data/Large_files/results_analysis_1.rds")
dat_analysis <- readRDS("../Data/Large_files/dat_analysis_results_analysis_1.rds")
########################################################################################################################
...
p1 <- ggplot(ce_pc1[[1]], aes(x = -PC1, y = (estimate__+1), group=guild)) + 
geom_point(data = dat_analysis, aes(x = -PC1, y = Interaction, colour=guild),size = 2.5, alpha=0.15) + 
geom_line(aes(colour=guild, linetype=guild, size=guild)) + 
...
xlab("") +
annotate(geom = "text", x = -0.1, y =0.35 , label = "Flower number - Flower size axis", size = 8.5, fontface =2) + 
xlab("") + 
theme(legend.position = "none",plot.title = element_text(size=rel(2.5),hjust = 0,face="bold"),panel.border=element_rect(color="black",size=1.2))  +
scale_linetype_manual(values=c("solid","twodash", "dotted", "longdash", "dashed", "dotdash"), labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera", "Non-syrphid-Diptera", "Syrphids"), name="Functional groups")+
scale_size_manual(values=c(1.75, 1.75, 1.5, 1.75, 1.75, 1.75), labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera", "Non-syrphid-Diptera", "Syrphids"), name="Functional groups")
...
p2 <- ggplot(ce_pc2[[1]], aes(x = -PC2, y = (estimate__+1), group=guild)) + 
geom_point(data = dat_analysis, aes(x = -PC2, y = Interaction, colour=guild),size = 2.5, alpha=0.15) + 
geom_line(aes(colour=guild, linetype=guild, size=guild))+ 
coord_cartesian(ylim=c(1,100),clip="off") + 
ylab(NULL)  +
theme_ms() + 
scale_color_manual(name="Functional groups",values=c("orange", "limegreen", "black","#E7298A",            "cyan4","blueviolet"),labels=c("Bees","Coleoptera", "Lepidoptera", "Non-bee-Hymenoptera",
        "Non-syrphid-Diptera", "Syrphids")) + scale_y_log10()+
...
p3 <-  ggplot(ce_pc3[[1]], aes(x = -PC3, y = (estimate__+1), group=guild)) + 
geom_point(data = dat_analysis, aes(x = -PC3, y = Interaction, colour=guild),size = 2.5, alpha=0.15) + 
geom_line(aes(colour=guild, linetype=guild, size=guild))+ 
coord_cartesian(ylim=c(1,100),clip="off") + 
ylab(NULL)  +
theme_ms() + 
