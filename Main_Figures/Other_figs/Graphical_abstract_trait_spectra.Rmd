...
all_spp <- function(PC, x="PC1", y="PC2") {
  ...
  #  scale_alpha(guide = 'none')
    ...
    plot <- plot + geom_point(data=dat, aes(x, y),size=3, color="grey69")
  ...
  # add arrows
  plot <- plot + geom_segment(data=datapc,linejoin="round", lineend="round",aes(x=0, y=0, xend=-v1, yend=-v2),size=5.5, arrow=arrow(length=unit(0.5,"cm")), alpha=0.5, colour=c("#74c365"))
