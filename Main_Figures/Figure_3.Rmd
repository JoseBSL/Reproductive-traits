...
theme_ms <- function(base_size=14, base_family="Helvetica") {
  (theme_bw(base_size = base_size, base_family = base_family)+
     theme(text=element_text(color="black"),
           ...
           panel.border=element_rect(color="black",size=2.5),
...
p1 <- readRDS("../Main_Figures/Other_figs/figure_3_1.rds")
p2 <- readRDS("../Main_Figures/Other_figs/figure_3_2.rds")
p3 <- readRDS("../Main_Figures/Other_figs/figure_3_3.rds")
pp1 <- readRDS("../Main_Figures/Other_figs/figure_3_4.rds")
pp2 <- readRDS("../Main_Figures/Other_figs/figure_3_5.rds")
pp3 <- readRDS("../Main_Figures/Other_figs/figure_3_6.rds")
