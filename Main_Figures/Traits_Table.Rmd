...
kable(dat,"latex", longtable = T, booktabs = T,linesep = "\\addlinespace") %>%
  kable_styling(latex_options = c("repeat_header","striped"), font_size = 12, full_width=F,position = "left") %>% collapse_rows(columns = c(1,3), valign = "middle") 
