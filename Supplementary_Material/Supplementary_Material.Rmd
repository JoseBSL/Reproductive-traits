...
Supplementary Fig. S8: Visitation rate of the main bee families on the main axes of trait variation
...
-	Flower morphology: We looked for images and illustrations of the flowers from the different species on the floras and available resources in order to categorize the flower shape. We divided the flowers in 8 main different categories: open, bowl, tube, campanulate, funnelform, papilionaceous, brush and capitulum. Finally, because some of the flower shapes were rare in our dataset, we grouped them within the closest flower morphologies (e.g., bowl shape was included within in the open shape). Thus, we ended with 6 distinct morphological groups for analyses: tube, papilonaceous, open, capitulum, campanulate and brush (see scheme of the different flower morphologies below).
...
dat <- dat %>% mutate(across(is.numeric, ~ round(., 2)))
 ...
 kable(dat, longtable = T, booktabs = T,linesep = "\\addlinespace", escape=FALSE,  caption = "\\textbf{Supplementary Table S2 | Loadings of the first three axes of trait variation of the phylogenetic informed principal component analysis with the full set of species.}") %>%
...
kable(dat, longtable = T,"latex", booktabs = T,linesep = "\\addlinespace", escape=FALSE,  caption = "\\textbf{Supplementary Table S3 | Loadings of the first three axes of trait variation of the phylogenetic informed principal component analysis with the subset of species with data of nectar and pollen quantity.}") %>%
  kable_styling(latex_options = c("repeat_header","striped"), font_size = 12, full_width=F,position = "center") 
...
```{r, echo=FALSE, message=FALSE, cache=FALSE, results='hide', warning=FALSE, fig.height=10, fig.width=10,  fig.cap="\\textbf{Supplementary Fig. S2 |  Phylogenetic informed principal component analysis for the species that did not have missing values.}"}
setwd("~/R_Projects/Reproductive Traits")
...
```{r, echo=FALSE, message=FALSE, cache=FALSE, results='hide', warning=FALSE, fig.height=10, fig.width=10, fig.cap="\\textbf{Supplementary Fig. S6 | Phylogenetic informed principal component analysis for the subset of species with floral rewards.}"}
setwd("~/R_Projects/Reproductive Traits")
