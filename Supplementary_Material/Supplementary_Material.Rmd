...
dat <- dat %>% mutate(across(is.numeric, ~ round(., 2)))
 ...
 kable(dat, longtable = T, booktabs = T,linesep = "\\addlinespace", escape=FALSE,  caption = "\\textbf{Table S2.} Loadings and explained variance of the first three principal components from the phylogenetically informed principal component analysis for the full set of species (N = 1,506).") %>%
