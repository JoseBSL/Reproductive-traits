---
title: \singlespacing \vspace{-2.5cm} \LARGE \textbf{Trade-offs among plant reproductive traits determine interactions with floral visitors}
...
```{r pressure, echo=FALSE, fig.cap="", out.width = '65%',fig.align='center', fig.cap="\\textbf{Supplementary text Fig. 1 | Main floral morphologies considered in this study.} All species were groupped within these categories for analysis: (a) tube, (b) papilonaceous, (c) open, (d) capitulum, (e) campanulate and (f) brush."}
