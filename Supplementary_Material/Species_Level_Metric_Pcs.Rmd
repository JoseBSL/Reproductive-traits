...
annotate(geom = "text", x = -1.65, y =-0.41 ,
...
annotate(geom = "text", x = -1.57, y =-0.3 , 
               label = "High aut. selfing", size = 8) +
annotate(geom = "text", x = -1.45, y =-0.41 ,
               label = "Small floral display", size = 8) + 
annotate(geom = "text", x = 1.75, y =-0.3 , 
               label = "Low aut. selfing", size = 8) + 
annotate(geom = "text", x = 1.9, y =-0.41 ,
               label = "Large floral display", size = 8) +
annotate(geom = "text", x = 0.10, y =-0.19 , 
    label = "Autonomous selfing - Floral display axis", size = 8.5, fontface =2) +
theme(panel.border=element_rect(color="black",size=1.2))
...
annotate(geom = "text", x = -1.35, y =-0.41 ,
         label = "Low aut. selfing", size = 8) + 
annotate(geom = "text", x = 2.05, y =-0.3 , 
         label = "Long styles", size = 8) + 
annotate(geom = "text", x = 2.3, y =-0.41 ,
         label = "High aut. selfing", size = 8) +
annotate(geom = "text", x = 0.25, y =-0.19 , 
         label = "Style length - Autonomous selfing axis", 
         size = 8.5, fontface =2) +
theme(panel.border=element_rect(color="black",size=1.2)) +
xlab(NULL)
