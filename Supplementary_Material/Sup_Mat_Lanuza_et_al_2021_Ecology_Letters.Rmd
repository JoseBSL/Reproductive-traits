...
-	Flower and inflorescence size: We searched for flower length and flower and inflorescence width (mm) for all species. When possible, we calculated the not found measurements with the help of online images and  the software ImageJ. Note that for species with compound flowers (e.g., Asteraceae) or similar floral structures we considered the actual inflorescence as the floral unit and the inflorescence or group of inflorescences as the inflorescence. For each species this is indicated in the dataset with the field of "info_level". For analysis just flower and capitulum level were considered but for some Asteraceae species information about ray and disc florets were also annotated.
