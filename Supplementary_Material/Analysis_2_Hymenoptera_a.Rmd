...
```{r, echo=FALSE, message=FALSE, cache=FALSE, results='hide', warning=FALSE, fig.height=10, fig.width=14,fig.pos = "!H",fig.cap= ""}
...
aes(x = -PC1, y = Interaction),size = 2.5, alpha=0.4) + geom_line(size=1.5)  + ylab("Interaction")+ xlab("")+
  theme_ms() + theme(legend.position = "none",plot.title = element_text(face="bold")) + scale_color_manual(name="Functional groups",values=c("orange", "black", "limegreen","#E7298A", "cyan4","blueviolet"))+scale_y_continuous(breaks = c(0,  1), labels=c("No", "Yes"))
