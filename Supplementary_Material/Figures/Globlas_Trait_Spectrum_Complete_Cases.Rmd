...
PC <- readRDS("Data/RData/phyl_pca_forest_complete_cases.rds")
...
all_spp <- function(PC, x="PC1", y="PC2") {
  ...
  plot <- plot + annotate("text", x = (PCAloadings$PC1*c(4.2,5.3,5,6.25,6.3,6.15)), y = -(PCAloadings$PC2*c(4.2,5,4,6.5,5,5.5)+c(0,0,0,0,0.25,0)),
