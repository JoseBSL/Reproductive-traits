...
ggtitle("(e)") +
annotate(geom = "text", x = -1.75, y =0.2 , label = "High aut. selfing", size = 8) +
annotate(geom = "text", x = -1.6, y =0.12 , label = "Small floral display", size = 8) + 
annotate(geom = "text", x = 1.8, y =0.2 , label = "Low aut. selfing", size = 8) + 
annotate(geom = "text", x = 2, y =0.12 , label = "Large floral display", size = 8) +
xlab(NULL) +
...
scale_color_manual(name="Functional groups",values=c("orange", 
        "black", "limegreen","#E7298A", "cyan4","blueviolet")) + scale_y_log10() + 
ggtitle("(f)") +
annotate(geom = "text", x = -1.35, y =0.2 , label = "Short styles", size = 8) +
annotate(geom = "text", x = -1.15, y =0.12 , label = "Low aut. selfing", size = 8) + 
annotate(geom = "text", x = 1.95, y =0.2 , label = "Long styles", size = 8) + 
annotate(geom = "text", x = 2.2, y =0.12 , label = "High aut. selfing", size = 8) +
xlab(" \n \n  ") +
annotate(geom = "text", x = 0.25, y =0.35 , label = "Style length - Autnomous selfing axis", size = 8.5, fontface =2) +
theme(panel.border=element_rect(color="black",size=1.2))
