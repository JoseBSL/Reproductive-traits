...
a1 <- ggplot(ce_pc1[[1]], aes(x = -PC1, y = (estimate__+1), group=bee_family, colour=bee_family)) + geom_point(data = dat_analysis,
  ...
  theme_ms() + theme(legend.position = "none") +  scale_color_manual(name="Functional groups",labels=c("Andrenidae","Apidae", "Colletidae", "Halictidae",
   "Megachilidae", "All families"),values=c("blueviolet", "black", "limegreen","#E7298A", "cyan4","orange"),
    limits = c("Andrenidae","Apidae", "Colletidae", "Halictidae","Megachilidae", "All families"))+ggtitle("All bee species") + theme(plot.title = element_text(size = 36, face = "bold"))
#Plot nicely PC2
...
a2 <- ggplot(ce_pc2[[1]], aes(x = -PC2, y = (estimate__+1), group=bee_family, colour=bee_family)) + geom_point(data = dat_analysis,
  ...
  theme_ms() + theme(legend.position = "none") +  scale_color_manual(name="Functional groups",labels=c("Andrenidae","Apidae", "Colletidae", "Halictidae",
   "Megachilidae", "All families"),values=c("blueviolet", "black", "limegreen","#E7298A", "cyan4","orange"),
    limits = c("Andrenidae","Apidae", "Colletidae", "Halictidae","Megachilidae", "All families"))
...
aa1 <- ggplot(ce_pc1[[1]], aes(x = -PC1, y = (estimate__+1), group=bee_family, colour=bee_family)) + geom_point(data = dat_analysis,
  aes(x = -PC1, y = Interaction),size = 2.5, alpha=0.5) + geom_line(size=1.4) + 
  ylim(0,quantile(dat_analysis$Interaction, 0.95)) + ylab("Number of visits")+ xlab("PC1")+
  theme_ms() + theme(legend.position = "none") +  scale_color_manual(name="Functional groups",labels=c("Andrenidae","Apidae", "Colletidae", "Halictidae",
   "Megachilidae", "All families"),values=c("blueviolet", "black", "limegreen","#E7298A", "cyan4","orange"),
    limits = c("Andrenidae","Apidae", "Colletidae", "Halictidae","Megachilidae", "All families"))+ ggtitle("A. mellifera excluded") + theme(plot.title = element_text(size = 36, face = "bold"))
#Plot nicely PC2
ce_pc2 <- conditional_effects(analysis_1_bee_families_non_apis, effects = "PC2:bee_family",points=T) 

aa2 <- ggplot(ce_pc2[[1]], aes(x = -PC2, y = (estimate__+1), group=bee_family, colour=bee_family)) + geom_point(data = dat_analysis,
  aes(x = -PC2, y = Interaction),size = 2.5, alpha=0.5) + geom_line(size=1.4) + 
  ylim(0,quantile(dat_analysis$Interaction, 0.95)) + ylab("")+ xlab("PC2")+
  theme_ms() + theme(legend.position = "none") +  scale_color_manual(name="Functional groups",labels=c("Andrenidae","Apidae", "Colletidae", "Halictidae",
   "Megachilidae", "All families"),values=c("blueviolet", "black", "limegreen","#E7298A", "cyan4","orange"),
...
aa3 <- ggplot(ce_pc3[[1]], aes(x = -PC3, y = (estimate__+1), group=bee_family, colour=bee_family)) + geom_point(data = dat_analysis,
  aes(x = -PC3, y = Interaction),size = 2.5, alpha=0.5) + geom_line(size=1.4) + 
  ylim(0,quantile(dat_analysis$Interaction, 0.95)) + ylab("")+ xlab("PC3")+
  theme_ms() + theme(legend.position = "none")+  scale_color_manual(name="Functional groups",labels=c("Andrenidae","Apidae", "Colletidae", "Halictidae",
   "Megachilidae", "All families"),values=c("blueviolet", "black", "limegreen","#E7298A", "cyan4","orange"),
...
p1 <- ggplot(ce_pc1[[1]], aes(x = -PC1, y = (estimate__+1))) + geom_point(data = dat_analysis,
  ...
  ylim(0,quantile(dat_analysis$Interaction, 0.95)) + ylab("Number of visits")+ xlab("PC1")+
  theme_ms() + theme(legend.position = "none") + ggtitle("All bee species")+
...
pp1 <- ggplot(ce_pc1[[1]], aes(x = -PC1, y = (estimate__+1))) + geom_point(data = dat_analysis,
      aes(x = -PC1, y = Interaction),size = 2.5, alpha=0.5, color="orange") + geom_line(size=1.4, color="orange")+  ylim(0,quantile(dat_analysis$Interaction, 0.95)) + ylab("Number of visits")+ xlab("PC1")+
  theme_ms() + theme(legend.position = "none") + ggtitle("A. mellifera excluded") + theme(plot.title = element_text(size = 36, face = "bold"))
...
combined <- a1 + a2 + a3 + aa1 + aa2 + aa3 + p1 + p2 + p3 + pp1 + pp2 + pp3 & theme(legend.position = "right")
