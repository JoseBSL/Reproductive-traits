...
```{r, echo=FALSE, message=FALSE, cache=FALSE, results='hide', warning=FALSE, fig.height=9, fig.width=11}
...
rpart.plot(tree1, box.palette="GnOr", main="Interaction frequency", cex.main=2,tweak = 1.20) 
rpart.plot(tree2, box.palette="GnOr", main="Normalized degree", cex.main=2,tweak = 1.20)
rpart.plot(tree3, box.palette="GnOr", main="Specialization", cex.main=2,tweak = 1.20)
