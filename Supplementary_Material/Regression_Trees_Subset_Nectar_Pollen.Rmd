...
```{r, echo=FALSE, message=FALSE, cache=FALSE, results='hide', warning=FALSE, fig.height=4, fig.width=11}
...
rpart.plot(tree1, box.palette="GnOr", main="(a) Interaction frequency", cex.main=1.5,tweak = 1) 
rpart.plot(tree2, box.palette="GnOr", main="(b) Normalized degree", cex.main=1.5,tweak = 1)
rpart.plot(tree3, box.palette="GnOr", main="(c) Specialization", cex.main=1.5,tweak = 0.9)
