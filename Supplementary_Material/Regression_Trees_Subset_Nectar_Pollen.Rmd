...
set.seed(2)
tree3 <- rpart(Specialization~., data=d_df, cp=0.0190352) #7node divisons

par(mfrow=c(1,3))


rpart.plot(tree1, box.palette="GnOr", main="(a) Interaction frequency", cex.main=1.5,tweak = 1.15,type = 2) 
