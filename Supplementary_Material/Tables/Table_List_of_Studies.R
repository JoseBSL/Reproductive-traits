#####
#Table with the list of 28 plant-pollinator studies and their network contribution 
#####
...
`Network structure` <- c(rep("Unique", 22), rep("Metaweb",6))
...
references <- data.frame(`First author`, `Number of networks`, `Network type`, `Network structure`, Year, Country, DOI)

#Check if sum of networks is correct (it is 60 weighted, 4 unw. and 8 metawebs)
sum(as.numeric(references$Number.of.networks))
