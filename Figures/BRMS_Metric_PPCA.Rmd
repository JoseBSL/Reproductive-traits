...
```{r, echo=FALSE, message=FALSE, cache=FALSE, results='hide', warning=FALSE, fig.height=13, fig.width=17}
...
Visits_PC1 <- ggplot(ce_1[[1]], aes(x = PC1, y = (estimate__+1))) + geom_point(data = data_analysis2,aes(x = PC1, y = Visits),
  ...
  geom_ribbon(aes(ymin=(lower__+1), ymax=(upper__+1)), linetype=2, alpha=0.1,fill="darkblue") + ylab("Number of visits")+ ggtitle("A")
...
Visits_PC2 <- ggplot(ce_2[[1]], aes(x = PC2, y = (estimate__+1))) + geom_point(data = data_analysis2,aes(x = PC2, y = Visits),
  ...
  geom_ribbon(aes(ymin=(lower__+1), ymax=(upper__+1)), linetype=2, alpha=0.1) + ylab("Number of visits") + ggtitle("B")
...
Specialization_PC1 <- ggplot(spe_1[[1]], aes(x = PC1, y = (estimate__))) + geom_point(data = data_analysis2,aes(x = PC1, y = d),
                      ...
                      geom_ribbon(aes(ymin=(lower__), ymax=(upper__)), linetype=2, alpha=0.1) + ylab("Specilization (d')") + ggtitle("C")

Specialization_PC2 <- ggplot(spe_2[[1]], aes(x = PC2, y = (estimate__))) + geom_point(data = data_analysis2,aes(x = PC2, y = d),
                      size = 1.2, alpha=0.9) + geom_line(size=1.2)  +theme_ms()+
                      geom_ribbon(aes(ymin=(lower__), ymax=(upper__)), linetype=2, alpha=0.1) + ylab("Specilization (d')") + ggtitle("D")
