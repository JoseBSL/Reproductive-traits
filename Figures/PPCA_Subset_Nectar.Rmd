...
nectar_subset <- function(PC, x="PC1", y="PC2") {
  ...
  plot <- plot + geom_point(data=dat, aes(-x, -y, colour=Nectar),size=2)+scale_color_manual(values=c("grey", "black"))
  ...
  plot <- plot + annotate("text", x = -(PCAloadings$PC1*c(6,5.35,5.2,6,6,6,6)), y = -(PCAloadings$PC2*c(5.75,5,4.3,5.75,5.8,5.5,6)),
...
nectar_subset(phyl_pca_forest_nectar)
