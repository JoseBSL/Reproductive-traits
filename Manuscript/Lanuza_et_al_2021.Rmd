...
Although there is an increasing number of macroecological studies that investigate plant reproductive traits [@baude2016; @munoz2016; @grossenbacher2017; @moeller2017], we still have poor understanding of how reproductive traits drive interactions with floral visitors at large ecological scales [@sargent2008; @rech2016; @salguero2016; @ruger2018]. The use of 
trait-based approaches [@fenster2004; @rosas2014] and trait-matching analyses [@stang2009; @bartomeus2016] has shown to be of great importance when exploring the drivers of plant-pollinator interactions. Interestingly, because the species' morphology can determine the species' functional role, 



because the species' morphology can determine the species' functional role, by linking the plant's position in the reproductive trait-space with the different floral visitor groups [as done in @dehling2016], we can investigate how the different reproductive trait correlations from the reproductive spectrum associate with the distinct floral visitor groups. However, plant reproductive traits remain overlooked for a great number of plant species [@dellinger2020] and is still unclear how specific reproductive traits like mating or compatibility system influence plant-pollinator associations [@tur2013; @devaux2014].
