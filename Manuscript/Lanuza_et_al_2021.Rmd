...
This study investigates the reproductive spectrum of flowering plants and shows that plants have clear positive and negative correlations between reproductive traits that determine interactions with floral visitors at a global scale. Despite the enormous variability of plant reproductive structures, three axes were able to capture over 70% of reproductive trait variation. The first axis was the flower number - flower size and described the negative association between flower number and flower size. Although this negative correlation has received substantial attention [worley2000; @sargent2007; @kettle2011], it has only been investigated across a few hundred of Angiosperm species and without a multitrait perspective. Here, we provide support to this evidence and show that also key reproductive traits to plant reproduction like ovule number and style length are positively correlated with flower size and negatively correlated with flower number. The second axis organized the species by the degree of pollinator dependence where species with higher pollinator dependence showed greater floral display.
