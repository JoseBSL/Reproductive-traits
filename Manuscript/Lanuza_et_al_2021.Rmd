...
Although the negative correlation between flower number and flower size has received substantial attention [worley2000; @sargent2007; @kettle2011], it has only been investigated across a few hundred of Angiosperm species with a two-trait approach. Here, we provide support to this evidence with a great diversity of phylogenetic lineages (170 families and over 1000 species) and show that other important traits like ovule number, style length and plant height also covariate along this reproductive axis. 

quizas citar aqui el paper de maleness...

Hablar de los otros ejes ahora
