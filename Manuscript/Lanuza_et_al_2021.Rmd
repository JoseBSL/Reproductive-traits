...
To conclude, we provide a robust description of the reproductive covariation patterns of animal pollinated species from plant-pollinator networks with the help of a global dataset of plant reproductive traits. Our work is a first step to elucidate the reproductive spectrum of flowering plants and highlights the relevance of floral visitors in the understanding of the different reproductive trait correlations. 

To better understand the reproductive spectrum of plant trait variation, there are several other reproductive traits that 



Future work needs to provide a more detailed description of the reproductive trait correlations by including other key reproductive traits that may affect these covariation patterns.


Despite we provide a detailed exploration with numerous reproductive traits, other reproductive traits that can affect these trait correlations need to be also accounted (e.g., flower colour and life span or more detailed exploration of floral rewards). Future work needs to integrate these reproductive correlations with the already described morphological and physiological plant correlations in order to better understand the global spectrum of plant form and function.




Future work needs to integrate the reproductive compromises that we have identified with vegetative and physiological trade-offs to create a more comprehensive spectrum of plant trait variation. Further, the varying level of phylogenetic signal among traits deserves further attention to understand evolutionary changes on mating and flower morphology in response to pollinators [@gervasi2017; @mackin2021]. Finally, including plant-pollinator networks from unrepresented areas of the world and a more complete description of plant reproductive trade-offs is essential for a better understanding of the global patterns in plant-pollinator interactions.
