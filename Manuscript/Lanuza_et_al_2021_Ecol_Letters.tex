...
All species names, genera, families and orders were retrieved and standardized from the taxonomy data sources NCBI (\url{https://www.ncbi.nlm.nih.gov/taxonomy}) for plants and ITIS (\url{https://www.itis.gov/}) for pollinators, using the R package \emph{taxize} (\protect\hyperlink{ref-chamberlain2020}{Chamberlain \emph{et al.} 2020}) version \emph{0.9.99}. We filled the `not found' searches manually using \url{http://www.theplantlist.org/} and \url{http://www.mobot.org/} for plants and \url{http://www.catalogueoflife.org/} for floral visitors.
...
\caption{\label{tab:unnamed-chunk-1}\textbf{Table 1} Plant functional traits used in this study.}
\centering
...
\midrule
\textbf{Vegetative} & \makecell[c]{Plant height \\ (m)} & \textbf{Vegetative} & Lifepan & \makecell[l]{Short-lived \\ Perennial}\\
\addlinespace
\textbf{Floral} & \makecell[c]{Flower width \\ (mm)} & \textbf{Vegetative} & Life form & \makecell[l]{Herb \\ Shrub \\ Tree}\\
\addlinespace
\textbf{Floral} & \makecell[c]{Flower length \\ (mm)} & \textbf{Floral} & \makecell[c]{Flower \\ shape} & \makecell[l]{Brush \\ Campanulate \\ Capitulum \\ Open \\ Papilionaceous \\ Tube}\\
\addlinespace
\textbf{Floral} & \makecell[c]{Inflorescence width \\ (mm)} & \textbf{Floral} & \makecell[c]{Flower \\ symmetry} & \makecell[l]{Actinomorphic \\ Zygomorphic}\\
\addlinespace
\textbf{Floral} & \makecell[c]{Style length \\ (mm)} & \textbf{Floral} & Nectar & \makecell[l]{Presence \\ Absence}\\
\addlinespace
\textbf{Floral} & Ovules per flower & \textbf{\makecell[c]{Reproductive \\ biology}} & \makecell[c]{Compatibility \\ system} & \makecell[l]{Self-incompatible \\ Part. self-compatible \\ Self-compatible}\\
\addlinespace
\textbf{Floral} & Flowers per plant & \textbf{\makecell[c]{Reproductive \\ biology}} & \makecell[c]{Breeding \\ system} & \makecell[l]{Hermaphrodite \\ Monoecious \\ Dioecious}\\
\addlinespace
\textbf{Floral} & \makecell[c]{Nectar \\ ($\mu$l)} & \textbf{\makecell[c]{Reproductive \\ biology}} & \makecell[c]{Autonomous \\ selfing} & \makecell[l]{None \\ Low \\ Medium \\ High}\\
\addlinespace
\textbf{Floral} & \makecell[c]{Nectar \\ (mg)} & \textbf{} &  & \\
\addlinespace
\textbf{Floral} & \makecell[c]{Nectar concentration \\ ($\%$)} & \textbf{} &  & \\
\addlinespace
\textbf{Floral} & \makecell[c]{Pollen grains \\ per flower} & \textbf{} &  & \\
\addlinespace
\textbf{\makecell[c]{Reproductive \\ biology}} & \makecell[c]{Autonomous selfing \\ (fruit set)} & \textbf{} &  & \\
\bottomrule
\end{tabular}
\end{table}
