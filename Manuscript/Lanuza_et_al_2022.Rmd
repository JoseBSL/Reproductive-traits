...
\textbf{Jose B. Lanuza$^{1,2}$} \orcidlink{0000-0002-0287-409X}, \textbf{Romina Rader$^{1}$} \orcidlink{0000-0001-9056-9118}, \textbf{Jamie Stavert$^{3}$} \orcidlink{0000-0002-2103-5320}, \textbf{Liam K. Kendall$^{4}$} \orcidlink{0000-0002-0671-0121}, \textbf{Manu E. Saunders$^{1}$} \orcidlink{0000-0003-0645-8277}
\textbf{and Ignasi Bartomeus$^{2}$}
\orcidlink{0000-0001-7893-4389}
...
[Table 1 has a 10^3 which should be 1000]()
...
[asegurate que cuadran los subtitulos de metodos con esto si los modificas]()
...
[Me falta un parrafo de por que esto es importante o que puede hacer la gente con esto. Seria el penultimo parrafo, por ejemplo, como afecta esto a la gente haciendo coexistencia (e.g. el paper de Pauw y el tuyo). Como afecta esto a la gente hacienco estabilidad y estructura de polinizadores. Como afecta esto a ecologos evolutivos?]()
...
**Data accessibility.** All data and code used to conduct this study is available at Zenodo (https://doi.org/10.5281/zenodo.6705621) and Github (https://github.com/JoseBSL/Reproductive-traits).
