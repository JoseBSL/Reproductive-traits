...
that are shaped by the interaction between plants and floral visitors.

that is mediated by the interaction with floral visitors wich ultimately

need to be included when exploring the global spectrum of trait variation of flowering plants.

are mediated by floral visitors.
